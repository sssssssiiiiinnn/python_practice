...
def main():
    ...
    parser.add_option('-q', action='store_true', dest='verbose', default=True)
    ...
    parser.add_option('--release', action='callback', callback=is_release, dest='is_release')

    group = OptionGroup(parser, 'Dangerous')
